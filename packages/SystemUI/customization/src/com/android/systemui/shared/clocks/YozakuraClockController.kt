...
// Yozakura sakura-pink default clock color
private const val YOZAKURA_SEED = 0xFFF48FB1.toInt()
...
class YozakuraClockController(
    ...
    override val config: ClockConfig by lazy {
        ClockConfig(
            YOZAKURA_CLOCK_ID,
            resources.getString(customR.string.clock_yozakura_name),
            resources.getString(customR.string.clock_yozakura_description),
        )
    }
    ...
    init {
        ...
        smallClock =
            DefaultClockFaceController(
                layoutInflater.inflate(customR.layout.clock_yozakura_small, parent, false)
                    as AnimatableClockView,
                (settings?.seedColor ?: YOZAKURA_SEED),
                messageBuffers?.smallClockMessageBuffer,
            )
        largeClock =
            LargeClockFaceController(
                layoutInflater.inflate(customR.layout.clock_yozakura_large, parent, false)
                    as AnimatableClockView,
                (settings?.seedColor ?: YOZAKURA_SEED),
        ...
        override val events =
            object : ClockFaceEvents {
                ...
                override fun onThemeChanged(theme: ThemeConfig) {
                    ...
                    val color = theme.seedColor ?: YOZAKURA_SEED
