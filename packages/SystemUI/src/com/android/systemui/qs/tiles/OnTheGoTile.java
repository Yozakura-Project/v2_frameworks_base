...
public class OnTheGoTile extends QSTileImpl<BooleanState> {
    ...
    public int getMetricsCategory() {
        // YozakuraOS: Infinity returns its own MetricsEvent.INFINITY, which this tree
        // does not define. The other Lineage tiles here (Caffeine, HeadsUp, Sync) all
        // report VIEW_UNKNOWN, so follow that rather than adding a metrics constant.
